...
execs/mat_mult/mat_mult_arm_O0:     file format elf32-littlearm
...
00010510 <_start>:
   ...
   10540:	00010c38 	.word	0x00010c38
   10544:	00010638 	.word	0x00010638
   10548:	00010bd8 	.word	0x00010bd8
...
00010638 <main>:
   ...
   10668:	eb00013f 	bl	10b6c <mat_mult_arm>
...
00010768 <alloc_array>:
   ...
   10820:	00010c48 	.word	0x00010c48
   10824:	00010c68 	.word	0x00010c68
...
000109c8 <check_result>:
   ...
   10b64:	00010c88 	.word	0x00010c88
   10b68:	00010ca4 	.word	0x00010ca4

00010b6c <mat_mult_arm>:
   10b6c:	e92d41f0 	push	{r4, r5, r6, r7, r8, lr}
   10b70:	e3a08efa 	mov	r8, #4000	; 0xfa0
   10b74:	e3a05000 	mov	r5, #0

00010b78 <i_loop>:
   10b78:	e3a06000 	mov	r6, #0

00010b7c <j_loop>:
   10b7c:	e3a07000 	mov	r7, #0

00010b80 <k_loop>:
   10b80:	e3a03ffa 	mov	r3, #1000	; 0x3e8
   10b84:	e7909005 	ldr	r9, [r0, r5]
   10b88:	e799a007 	ldr	sl, [r9, r7]
   10b8c:	e7919007 	ldr	r9, [r1, r7]
   10b90:	e7994006 	ldr	r4, [r9, r6]
   10b94:	e7929005 	ldr	r9, [r2, r5]
   10b98:	e7993006 	ldr	r3, [r9, r6]
   10b9c:	e00a049a 	mul	sl, sl, r4
   10ba0:	e083300a 	add	r3, r3, sl
   10ba4:	e7893006 	str	r3, [r9, r6]
   10ba8:	e2877004 	add	r7, r7, #4
   10bac:	e1570008 	cmp	r7, r8
   10bb0:	bafffff2 	blt	10b80 <k_loop>
   10bb4:	e2866004 	add	r6, r6, #4
   10bb8:	e1560008 	cmp	r6, r8
   10bbc:	baffffee 	blt	10b7c <j_loop>
   10bc0:	e2855004 	add	r5, r5, #4
   10bc4:	e1550008 	cmp	r5, r8
   10bc8:	baffffea 	blt	10b78 <i_loop>
   10bcc:	e8bd41f0 	pop	{r4, r5, r6, r7, r8, lr}
   10bd0:	e12fff1e 	bx	lr

00010bd4 <addr_size_bytes>:
   10bd4:	00021040 	.word	0x00021040

00010bd8 <__libc_csu_init>:
   10bd8:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   10bdc:	e1a07000 	mov	r7, r0
   10be0:	e59f6048 	ldr	r6, [pc, #72]	; 10c30 <__libc_csu_init+0x58>
   10be4:	e59f5048 	ldr	r5, [pc, #72]	; 10c34 <__libc_csu_init+0x5c>
   10be8:	e08f6006 	add	r6, pc, r6
   10bec:	e08f5005 	add	r5, pc, r5
   10bf0:	e0466005 	sub	r6, r6, r5
   10bf4:	e1a08001 	mov	r8, r1
   10bf8:	e1a09002 	mov	r9, r2
   10bfc:	ebfffe1d 	bl	10478 <_init>
   10c00:	e1b06146 	asrs	r6, r6, #2
   10c04:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   10c08:	e3a04000 	mov	r4, #0
   10c0c:	e2844001 	add	r4, r4, #1
   10c10:	e4953004 	ldr	r3, [r5], #4
   10c14:	e1a02009 	mov	r2, r9
   10c18:	e1a01008 	mov	r1, r8
   10c1c:	e1a00007 	mov	r0, r7
   10c20:	e12fff33 	blx	r3
   10c24:	e1560004 	cmp	r6, r4
   10c28:	1afffff7 	bne	10c0c <__libc_csu_init+0x34>
   10c2c:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   10c30:	00010318 	.word	0x00010318
   10c34:	00010310 	.word	0x00010310

00010c38 <__libc_csu_fini>:
   10c38:	e12fff1e 	bx	lr

Disassembly of section .fini:

00010c3c <_fini>:
   10c3c:	e92d4008 	push	{r3, lr}
   10c40:	e8bd8008 	pop	{r3, pc}
