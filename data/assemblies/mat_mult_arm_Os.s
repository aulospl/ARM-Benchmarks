...
execs/mat_mult/mat_mult_arm_Os:     file format elf32-littlearm
...
00010510 <main>:
   ...
   10538:	eb0000d3 	bl	1088c <mat_mult_arm>
...
0001055c <_start>:
   ...
   1058c:	00010958 	.word	0x00010958
   10590:	00010510 	.word	0x00010510
   10594:	000108f8 	.word	0x000108f8
...
000106f0 <alloc_array>:
   ...
   10748:	00010968 	.word	0x00010968
   1074c:	00010988 	.word	0x00010988
...
000107ec <check_result>:
   ...
   10884:	000109a8 	.word	0x000109a8
   10888:	000109c3 	.word	0x000109c3

0001088c <mat_mult_arm>:
   1088c:	e92d41f0 	push	{r4, r5, r6, r7, r8, lr}
   10890:	e3a08efa 	mov	r8, #4000	; 0xfa0
   10894:	e3a05000 	mov	r5, #0

00010898 <i_loop>:
   10898:	e3a06000 	mov	r6, #0

0001089c <j_loop>:
   1089c:	e3a07000 	mov	r7, #0

000108a0 <k_loop>:
   108a0:	e3a03ffa 	mov	r3, #1000	; 0x3e8
   108a4:	e7909005 	ldr	r9, [r0, r5]
   108a8:	e799a007 	ldr	sl, [r9, r7]
   108ac:	e7919007 	ldr	r9, [r1, r7]
   108b0:	e7994006 	ldr	r4, [r9, r6]
   108b4:	e7929005 	ldr	r9, [r2, r5]
   108b8:	e7993006 	ldr	r3, [r9, r6]
   108bc:	e00a049a 	mul	sl, sl, r4
   108c0:	e083300a 	add	r3, r3, sl
   108c4:	e7893006 	str	r3, [r9, r6]
   108c8:	e2877004 	add	r7, r7, #4
   108cc:	e1570008 	cmp	r7, r8
   108d0:	bafffff2 	blt	108a0 <k_loop>
   108d4:	e2866004 	add	r6, r6, #4
   108d8:	e1560008 	cmp	r6, r8
   108dc:	baffffee 	blt	1089c <j_loop>
   108e0:	e2855004 	add	r5, r5, #4
   108e4:	e1550008 	cmp	r5, r8
   108e8:	baffffea 	blt	10898 <i_loop>
   108ec:	e8bd41f0 	pop	{r4, r5, r6, r7, r8, lr}
   108f0:	e12fff1e 	bx	lr

000108f4 <addr_size_bytes>:
   108f4:	00021040 	.word	0x00021040

000108f8 <__libc_csu_init>:
   108f8:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   108fc:	e1a07000 	mov	r7, r0
   10900:	e59f6048 	ldr	r6, [pc, #72]	; 10950 <__libc_csu_init+0x58>
   10904:	e59f5048 	ldr	r5, [pc, #72]	; 10954 <__libc_csu_init+0x5c>
   10908:	e08f6006 	add	r6, pc, r6
   1090c:	e08f5005 	add	r5, pc, r5
   10910:	e0466005 	sub	r6, r6, r5
   10914:	e1a08001 	mov	r8, r1
   10918:	e1a09002 	mov	r9, r2
   1091c:	ebfffed5 	bl	10478 <_init>
   10920:	e1b06146 	asrs	r6, r6, #2
   10924:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   10928:	e3a04000 	mov	r4, #0
   1092c:	e2844001 	add	r4, r4, #1
   10930:	e4953004 	ldr	r3, [r5], #4
   10934:	e1a02009 	mov	r2, r9
   10938:	e1a01008 	mov	r1, r8
   1093c:	e1a00007 	mov	r0, r7
   10940:	e12fff33 	blx	r3
   10944:	e1560004 	cmp	r6, r4
   10948:	1afffff7 	bne	1092c <__libc_csu_init+0x34>
   1094c:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   10950:	000105f8 	.word	0x000105f8
   10954:	000105f0 	.word	0x000105f0

00010958 <__libc_csu_fini>:
   10958:	e12fff1e 	bx	lr

Disassembly of section .fini:

0001095c <_fini>:
   1095c:	e92d4008 	push	{r3, lr}
   10960:	e8bd8008 	pop	{r3, pc}
