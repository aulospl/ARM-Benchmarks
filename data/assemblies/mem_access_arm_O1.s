...
execs/mem_access/mem_access_arm_O1:     file format elf32-littlearm
...
00010510 <_start>:
   ...
   10540:	00010934 	.word	0x00010934
   10544:	0001073c 	.word	0x0001073c
   10548:	000108d4 	.word	0x000108d4
...
000106a4 <alloc_array>:
   ...
   10708:	00010944 	.word	0x00010944
   1070c:	00010964 	.word	0x00010964
...
0001073c <main>:
   ...
   10750:	eb00004c 	bl	10888 <mem_access_arm>
...
000107dc <check_result>:
   ...
   10880:	00010984 	.word	0x00010984
   10884:	000109a0 	.word	0x000109a0

00010888 <mem_access_arm>:
   10888:	e92d407e 	push	{r1, r2, r3, r4, r5, r6, lr}
   1088c:	e59f103c 	ldr	r1, [pc, #60]	; 108d0 <array_size_address>
   10890:	e5911000 	ldr	r1, [r1]
   10894:	e59f5030 	ldr	r5, [pc, #48]	; 108cc <tmp_addr>
   10898:	e3a02004 	mov	r2, #4
   1089c:	e3a03000 	mov	r3, #0
   108a0:	e3a04000 	mov	r4, #0

000108a4 <inner_loop>:
   108a4:	e7906004 	ldr	r6, [r0, r4]
   108a8:	e5856000 	str	r6, [r5]
   108ac:	e2844001 	add	r4, r4, #1
   108b0:	e1540001 	cmp	r4, r1
   108b4:	bafffffa 	blt	108a4 <inner_loop>
   108b8:	e2833001 	add	r3, r3, #1
   108bc:	e1530002 	cmp	r3, r2
   108c0:	bafffff7 	blt	108a4 <inner_loop>
   108c4:	e8bd407e 	pop	{r1, r2, r3, r4, r5, r6, lr}
   108c8:	e12fff1e 	bx	lr

000108cc <tmp_addr>:
   108cc:	00021044 	.word	0x00021044

000108d0 <array_size_address>:
   108d0:	00021040 	.word	0x00021040

000108d4 <__libc_csu_init>:
   108d4:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   108d8:	e1a07000 	mov	r7, r0
   108dc:	e59f6048 	ldr	r6, [pc, #72]	; 1092c <__libc_csu_init+0x58>
   108e0:	e59f5048 	ldr	r5, [pc, #72]	; 10930 <__libc_csu_init+0x5c>
   108e4:	e08f6006 	add	r6, pc, r6
   108e8:	e08f5005 	add	r5, pc, r5
   108ec:	e0466005 	sub	r6, r6, r5
   108f0:	e1a08001 	mov	r8, r1
   108f4:	e1a09002 	mov	r9, r2
   108f8:	ebfffede 	bl	10478 <_init>
   108fc:	e1b06146 	asrs	r6, r6, #2
   10900:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   10904:	e3a04000 	mov	r4, #0
   10908:	e2844001 	add	r4, r4, #1
   1090c:	e4953004 	ldr	r3, [r5], #4
   10910:	e1a02009 	mov	r2, r9
   10914:	e1a01008 	mov	r1, r8
   10918:	e1a00007 	mov	r0, r7
   1091c:	e12fff33 	blx	r3
   10920:	e1560004 	cmp	r6, r4
   10924:	1afffff7 	bne	10908 <__libc_csu_init+0x34>
   10928:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   1092c:	0001061c 	.word	0x0001061c
   10930:	00010614 	.word	0x00010614

00010934 <__libc_csu_fini>:
   10934:	e12fff1e 	bx	lr

Disassembly of section .fini:

00010938 <_fini>:
   10938:	e92d4008 	push	{r3, lr}
   1093c:	e8bd8008 	pop	{r3, pc}
