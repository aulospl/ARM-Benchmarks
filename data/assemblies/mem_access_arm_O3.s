...
execs/mem_access/mem_access_arm_O3:     file format elf32-littlearm
...
00010510 <main>:
   ...
   1054c:	eb0000e7 	bl	108f0 <mem_access_arm>
...
00010560 <_start>:
   ...
   10590:	0001099c 	.word	0x0001099c
   10594:	00010510 	.word	0x00010510
   10598:	0001093c 	.word	0x0001093c
...
000106f4 <alloc_array>:
   ...
   10758:	000109cc 	.word	0x000109cc
   1075c:	000109ac 	.word	0x000109ac
...
00010844 <check_result>:
   ...
   108ec:	000109ec 	.word	0x000109ec

000108f0 <mem_access_arm>:
   108f0:	e92d407e 	push	{r1, r2, r3, r4, r5, r6, lr}
   108f4:	e59f103c 	ldr	r1, [pc, #60]	; 10938 <array_size_address>
   108f8:	e5911000 	ldr	r1, [r1]
   108fc:	e59f5030 	ldr	r5, [pc, #48]	; 10934 <tmp_addr>
   10900:	e3a02004 	mov	r2, #4
   10904:	e3a03000 	mov	r3, #0
   10908:	e3a04000 	mov	r4, #0

0001090c <inner_loop>:
   1090c:	e7906004 	ldr	r6, [r0, r4]
   10910:	e5856000 	str	r6, [r5]
   10914:	e2844001 	add	r4, r4, #1
   10918:	e1540001 	cmp	r4, r1
   1091c:	bafffffa 	blt	1090c <inner_loop>
   10920:	e2833001 	add	r3, r3, #1
   10924:	e1530002 	cmp	r3, r2
   10928:	bafffff7 	blt	1090c <inner_loop>
   1092c:	e8bd407e 	pop	{r1, r2, r3, r4, r5, r6, lr}
   10930:	e12fff1e 	bx	lr

00010934 <tmp_addr>:
   10934:	00021044 	.word	0x00021044

00010938 <array_size_address>:
   10938:	00021040 	.word	0x00021040

0001093c <__libc_csu_init>:
   1093c:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   10940:	e1a07000 	mov	r7, r0
   10944:	e59f6048 	ldr	r6, [pc, #72]	; 10994 <__libc_csu_init+0x58>
   10948:	e59f5048 	ldr	r5, [pc, #72]	; 10998 <__libc_csu_init+0x5c>
   1094c:	e08f6006 	add	r6, pc, r6
   10950:	e08f5005 	add	r5, pc, r5
   10954:	e0466005 	sub	r6, r6, r5
   10958:	e1a08001 	mov	r8, r1
   1095c:	e1a09002 	mov	r9, r2
   10960:	ebfffec4 	bl	10478 <_init>
   10964:	e1b06146 	asrs	r6, r6, #2
   10968:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   1096c:	e3a04000 	mov	r4, #0
   10970:	e2844001 	add	r4, r4, #1
   10974:	e4953004 	ldr	r3, [r5], #4
   10978:	e1a02009 	mov	r2, r9
   1097c:	e1a01008 	mov	r1, r8
   10980:	e1a00007 	mov	r0, r7
   10984:	e12fff33 	blx	r3
   10988:	e1560004 	cmp	r6, r4
   1098c:	1afffff7 	bne	10970 <__libc_csu_init+0x34>
   10990:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   10994:	000105b4 	.word	0x000105b4
   10998:	000105ac 	.word	0x000105ac

0001099c <__libc_csu_fini>:
   1099c:	e12fff1e 	bx	lr

Disassembly of section .fini:

000109a0 <_fini>:
   109a0:	e92d4008 	push	{r3, lr}
   109a4:	e8bd8008 	pop	{r3, pc}
