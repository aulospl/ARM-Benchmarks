...
execs/mem_access/mem_access_arm_Os:     file format elf32-littlearm
...
00010510 <main>:
   ...
   10524:	eb0000cf 	bl	10868 <mem_access_arm>
...
00010538 <_start>:
   ...
   10568:	00010914 	.word	0x00010914
   1056c:	00010510 	.word	0x00010510
   10570:	000108b4 	.word	0x000108b4
...
00010598 <deregister_tm_clones>:
   ...
   105bc:	00021053 	.word	0x00021053
...
000105c8 <register_tm_clones>:
   ...
   105f4:	00021050 	.word	0x00021050
   105f8:	00021050 	.word	0x00021050
...
00010600 <__do_global_dtors_aux>:
   ...
   10624:	0002104d 	.word	0x0002104d
...
000106cc <alloc_array>:
   ...
   10724:	00010924 	.word	0x00010924
   10728:	00010944 	.word	0x00010944
...
000107c8 <check_result>:
   ...
   10860:	00010964 	.word	0x00010964
   10864:	0001097f 	.word	0x0001097f

00010868 <mem_access_arm>:
   10868:	e92d407e 	push	{r1, r2, r3, r4, r5, r6, lr}
   1086c:	e59f103c 	ldr	r1, [pc, #60]	; 108b0 <array_size_address>
   10870:	e5911000 	ldr	r1, [r1]
   10874:	e59f5030 	ldr	r5, [pc, #48]	; 108ac <tmp_addr>
   10878:	e3a02004 	mov	r2, #4
   1087c:	e3a03000 	mov	r3, #0
   10880:	e3a04000 	mov	r4, #0

00010884 <inner_loop>:
   10884:	e7906004 	ldr	r6, [r0, r4]
   10888:	e5856000 	str	r6, [r5]
   1088c:	e2844001 	add	r4, r4, #1
   10890:	e1540001 	cmp	r4, r1
   10894:	bafffffa 	blt	10884 <inner_loop>
   10898:	e2833001 	add	r3, r3, #1
   1089c:	e1530002 	cmp	r3, r2
   108a0:	bafffff7 	blt	10884 <inner_loop>
   108a4:	e8bd407e 	pop	{r1, r2, r3, r4, r5, r6, lr}
   108a8:	e12fff1e 	bx	lr

000108ac <tmp_addr>:
   108ac:	00021044 	.word	0x00021044

000108b0 <array_size_address>:
   108b0:	00021040 	.word	0x00021040

000108b4 <__libc_csu_init>:
   108b4:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   108b8:	e1a07000 	mov	r7, r0
   108bc:	e59f6048 	ldr	r6, [pc, #72]	; 1090c <__libc_csu_init+0x58>
   108c0:	e59f5048 	ldr	r5, [pc, #72]	; 10910 <__libc_csu_init+0x5c>
   108c4:	e08f6006 	add	r6, pc, r6
   108c8:	e08f5005 	add	r5, pc, r5
   108cc:	e0466005 	sub	r6, r6, r5
   108d0:	e1a08001 	mov	r8, r1
   108d4:	e1a09002 	mov	r9, r2
   108d8:	ebfffee6 	bl	10478 <_init>
   108dc:	e1b06146 	asrs	r6, r6, #2
   108e0:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   108e4:	e3a04000 	mov	r4, #0
   108e8:	e2844001 	add	r4, r4, #1
   108ec:	e4953004 	ldr	r3, [r5], #4
   108f0:	e1a02009 	mov	r2, r9
   108f4:	e1a01008 	mov	r1, r8
   108f8:	e1a00007 	mov	r0, r7
   108fc:	e12fff33 	blx	r3
   10900:	e1560004 	cmp	r6, r4
   10904:	1afffff7 	bne	108e8 <__libc_csu_init+0x34>
   10908:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   1090c:	0001063c 	.word	0x0001063c
   10910:	00010634 	.word	0x00010634

00010914 <__libc_csu_fini>:
   10914:	e12fff1e 	bx	lr

Disassembly of section .fini:

00010918 <_fini>:
   10918:	e92d4008 	push	{r3, lr}
   1091c:	e8bd8008 	pop	{r3, pc}
