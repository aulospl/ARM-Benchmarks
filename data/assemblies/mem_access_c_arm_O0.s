...
execs/mem_access/mem_access_c_arm_O0:     file format elf32-littlearm
...
00010434 <_start>:
   ...
   10464:	00010b5c 	.word	0x00010b5c
   10468:	0001055c 	.word	0x0001055c
   1046c:	00010afc 	.word	0x00010afc
...
0001055c <main>:
   ...
   1057c:	eb00013a 	bl	10a6c <mem_access_c>
...
0001066c <alloc_array>:
   ...
   10694:	e3000b6c 	movw	r0, #2924	; 0xb6c
   ...
   106f0:	e3000b8c 	movw	r0, #2956	; 0xb8c
...
000108c8 <check_result>:
   ...
   109ec:	e3000bac 	movw	r0, #2988	; 0xbac
   ...
   10a54:	e3000bc8 	movw	r0, #3016	; 0xbc8
...
00010a6c <mem_access_c>:
   10a6c:	e52db004 	push	{fp}		; (str fp, [sp, #-4]!)
   10a70:	e28db000 	add	fp, sp, #0
   10a74:	e24dd01c 	sub	sp, sp, #28
   10a78:	e50b0018 	str	r0, [fp, #-24]	; 0xffffffe8
   10a7c:	e3a03000 	mov	r3, #0
   10a80:	e50b3008 	str	r3, [fp, #-8]
   10a84:	ea000015 	b	10ae0 <mem_access_c+0x74>
   10a88:	e3a03000 	mov	r3, #0
   10a8c:	e50b300c 	str	r3, [fp, #-12]
   10a90:	ea00000c 	b	10ac8 <mem_access_c+0x5c>
   10a94:	e51b3008 	ldr	r3, [fp, #-8]
   10a98:	e1a03103 	lsl	r3, r3, #2
   10a9c:	e51b2018 	ldr	r2, [fp, #-24]	; 0xffffffe8
   ...
   10ab8:	e50b3010 	str	r3, [fp, #-16]
   10abc:	e51b300c 	ldr	r3, [fp, #-12]
   10ac0:	e2833001 	add	r3, r3, #1
   10ac4:	e50b300c 	str	r3, [fp, #-12]
   10ac8:	e51b300c 	ldr	r3, [fp, #-12]
   10acc:	e3530ffa 	cmp	r3, #1000	; 0x3e8
   10ad0:	baffffef 	blt	10a94 <mem_access_c+0x28>
   10ad4:	e51b3008 	ldr	r3, [fp, #-8]
   10ad8:	e2833001 	add	r3, r3, #1
   10adc:	e50b3008 	str	r3, [fp, #-8]
   10ae0:	e51b3008 	ldr	r3, [fp, #-8]
   10ae4:	e3530ffa 	cmp	r3, #1000	; 0x3e8
   10ae8:	baffffe6 	blt	10a88 <mem_access_c+0x1c>
   10aec:	e320f000 	nop	{0}
   10af0:	e28bd000 	add	sp, fp, #0
   10af4:	e49db004 	pop	{fp}		; (ldr fp, [sp], #4)
   10af8:	e12fff1e 	bx	lr

00010afc <__libc_csu_init>:
   10afc:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   10b00:	e1a07000 	mov	r7, r0
   10b04:	e59f6048 	ldr	r6, [pc, #72]	; 10b54 <__libc_csu_init+0x58>
   10b08:	e59f5048 	ldr	r5, [pc, #72]	; 10b58 <__libc_csu_init+0x5c>
   10b0c:	e08f6006 	add	r6, pc, r6
   10b10:	e08f5005 	add	r5, pc, r5
   10b14:	e0466005 	sub	r6, r6, r5
   10b18:	e1a08001 	mov	r8, r1
   10b1c:	e1a09002 	mov	r9, r2
   10b20:	ebfffe1d 	bl	1039c <_init>
   10b24:	e1b06146 	asrs	r6, r6, #2
   10b28:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   10b2c:	e3a04000 	mov	r4, #0
   10b30:	e2844001 	add	r4, r4, #1
   10b34:	e4953004 	ldr	r3, [r5], #4
   10b38:	e1a02009 	mov	r2, r9
   10b3c:	e1a01008 	mov	r1, r8
   10b40:	e1a00007 	mov	r0, r7
   10b44:	e12fff33 	blx	r3
   10b48:	e1560004 	cmp	r6, r4
   10b4c:	1afffff7 	bne	10b30 <__libc_csu_init+0x34>
   10b50:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   10b54:	000103fc 	.word	0x000103fc
   10b58:	000103f4 	.word	0x000103f4

00010b5c <__libc_csu_fini>:
   10b5c:	e12fff1e 	bx	lr

Disassembly of section .fini:

00010b60 <_fini>:
   10b60:	e92d4008 	push	{r3, lr}
   10b64:	e8bd8008 	pop	{r3, pc}
