...
execs/mem_access/mem_access_thumb_O0:     file format elf32-littlearm
...
00010510 <_start>:
   ...
   10540:	00010bec 	.word	0x00010bec
   10544:	00010638 	.word	0x00010638
   10548:	00010b8c 	.word	0x00010b8c
...
00010638 <main>:
   ...
   10660:	eb00013b 	bl	10b54 <mem_access_thumb>
...
00010750 <alloc_array>:
   ...
   10808:	00010bfc 	.word	0x00010bfc
   1080c:	00010c1c 	.word	0x00010c1c
...
000109b0 <check_result>:
   ...
   10b4c:	00010c3c 	.word	0x00010c3c
   10b50:	00010c58 	.word	0x00010c58

00010b54 <mem_access_thumb>:
   10b54:	e52de004 	push	{lr}		; (str lr, [sp, #-4]!)
   10b58:	fa000001 	blx	10b64 <thumb_code>
   10b5c:	e49de004 	pop	{lr}		; (ldr lr, [sp], #4)
   10b60:	e12fff1e 	bx	lr

00010b64 <thumb_code>:
   10b64:	4f08      	ldr	r7, [pc, #32]	; (10b88 <array_size_address>)
   10b66:	683f      	ldr	r7, [r7, #0]
   10b68:	4d06      	ldr	r5, [pc, #24]	; (10b84 <tmp_addr>)
   10b6a:	2204      	movs	r2, #4
   10b6c:	2300      	movs	r3, #0

00010b6e <outer_loop>:
   10b6e:	2400      	movs	r4, #0

00010b70 <inner_loop>:
   10b70:	5846      	ldr	r6, [r0, r1]
   10b72:	602e      	str	r6, [r5, #0]
   10b74:	3401      	adds	r4, #1
   10b76:	42a7      	cmp	r7, r4
   10b78:	dbfa      	blt.n	10b70 <inner_loop>
   10b7a:	3301      	adds	r3, #1
   10b7c:	429a      	cmp	r2, r3
   10b7e:	dbf6      	blt.n	10b6e <outer_loop>
   10b80:	4770      	bx	lr
   10b82:	46c0      	nop			; (mov r8, r8)

00010b84 <tmp_addr>:
   10b84:	00021044 	.word	0x00021044

00010b88 <array_size_address>:
   10b88:	00021040 	.word	0x00021040

00010b8c <__libc_csu_init>:
   10b8c:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   10b90:	e1a07000 	mov	r7, r0
   10b94:	e59f6048 	ldr	r6, [pc, #72]	; 10be4 <__libc_csu_init+0x58>
   10b98:	e59f5048 	ldr	r5, [pc, #72]	; 10be8 <__libc_csu_init+0x5c>
   10b9c:	e08f6006 	add	r6, pc, r6
   10ba0:	e08f5005 	add	r5, pc, r5
   10ba4:	e0466005 	sub	r6, r6, r5
   10ba8:	e1a08001 	mov	r8, r1
   10bac:	e1a09002 	mov	r9, r2
   10bb0:	ebfffe30 	bl	10478 <_init>
   10bb4:	e1b06146 	asrs	r6, r6, #2
   10bb8:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   10bbc:	e3a04000 	mov	r4, #0
   10bc0:	e2844001 	add	r4, r4, #1
   10bc4:	e4953004 	ldr	r3, [r5], #4
   10bc8:	e1a02009 	mov	r2, r9
   10bcc:	e1a01008 	mov	r1, r8
   10bd0:	e1a00007 	mov	r0, r7
   10bd4:	e12fff33 	blx	r3
   10bd8:	e1560004 	cmp	r6, r4
   10bdc:	1afffff7 	bne	10bc0 <__libc_csu_init+0x34>
   10be0:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   10be4:	00010364 	.word	0x00010364
   10be8:	0001035c 	.word	0x0001035c

00010bec <__libc_csu_fini>:
   10bec:	e12fff1e 	bx	lr

Disassembly of section .fini:

00010bf0 <_fini>:
   10bf0:	e92d4008 	push	{r3, lr}
   10bf4:	e8bd8008 	pop	{r3, pc}
