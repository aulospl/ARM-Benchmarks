...
execs/mem_access/mem_access_thumb_O2:     file format elf32-littlearm
...
00010510 <main>:
   ...
   1054c:	eb0000df 	bl	108d0 <mem_access_thumb>
...
00010560 <_start>:
   ...
   10590:	00010968 	.word	0x00010968
   10594:	00010510 	.word	0x00010510
   10598:	00010908 	.word	0x00010908
...
000106f4 <alloc_array>:
   ...
   10758:	00010998 	.word	0x00010998
   1075c:	00010978 	.word	0x00010978
...
00010824 <check_result>:
   ...
   108c8:	000109d4 	.word	0x000109d4
   108cc:	000109b8 	.word	0x000109b8

000108d0 <mem_access_thumb>:
   108d0:	e52de004 	push	{lr}		; (str lr, [sp, #-4]!)
   108d4:	fa000001 	blx	108e0 <thumb_code>
   108d8:	e49de004 	pop	{lr}		; (ldr lr, [sp], #4)
   108dc:	e12fff1e 	bx	lr

000108e0 <thumb_code>:
   108e0:	4f08      	ldr	r7, [pc, #32]	; (10904 <array_size_address>)
   108e2:	683f      	ldr	r7, [r7, #0]
   108e4:	4d06      	ldr	r5, [pc, #24]	; (10900 <tmp_addr>)
   108e6:	2204      	movs	r2, #4
...
000108ec <inner_loop>:
   108ec:	5846      	ldr	r6, [r0, r1]
   108ee:	602e      	str	r6, [r5, #0]
   108f0:	3401      	adds	r4, #1
   108f2:	42a7      	cmp	r7, r4
   108f4:	dbfa      	blt.n	108ec <inner_loop>
   108f6:	3301      	adds	r3, #1
   108f8:	429a      	cmp	r2, r3
   108fa:	dbf6      	blt.n	108ea <outer_loop>
   108fc:	4770      	bx	lr
   108fe:	46c0      	nop			; (mov r8, r8)

00010900 <tmp_addr>:
   10900:	00021044 	.word	0x00021044

00010904 <array_size_address>:
   10904:	00021040 	.word	0x00021040

00010908 <__libc_csu_init>:
   10908:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   1090c:	e1a07000 	mov	r7, r0
   10910:	e59f6048 	ldr	r6, [pc, #72]	; 10960 <__libc_csu_init+0x58>
   10914:	e59f5048 	ldr	r5, [pc, #72]	; 10964 <__libc_csu_init+0x5c>
   10918:	e08f6006 	add	r6, pc, r6
   1091c:	e08f5005 	add	r5, pc, r5
   10920:	e0466005 	sub	r6, r6, r5
   10924:	e1a08001 	mov	r8, r1
   10928:	e1a09002 	mov	r9, r2
   1092c:	ebfffed1 	bl	10478 <_init>
   10930:	e1b06146 	asrs	r6, r6, #2
   10934:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   10938:	e3a04000 	mov	r4, #0
   1093c:	e2844001 	add	r4, r4, #1
   10940:	e4953004 	ldr	r3, [r5], #4
   10944:	e1a02009 	mov	r2, r9
   10948:	e1a01008 	mov	r1, r8
   1094c:	e1a00007 	mov	r0, r7
   10950:	e12fff33 	blx	r3
   10954:	e1560004 	cmp	r6, r4
   10958:	1afffff7 	bne	1093c <__libc_csu_init+0x34>
   1095c:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   10960:	000105e8 	.word	0x000105e8
   10964:	000105e0 	.word	0x000105e0
