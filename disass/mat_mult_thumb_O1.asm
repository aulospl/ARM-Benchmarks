...
execs/mat_mult/mat_mult_thumb_O1:     file format elf32-littlearm
...
00010510 <_start>:
   ...
   10540:	00010970 	.word	0x00010970
   10544:	000106a4 	.word	0x000106a4
   10548:	00010910 	.word	0x00010910
...
000106a4 <main>:
   ...
   106cc:	eb000077 	bl	108b0 <mat_mult_thumb>
...
000106f0 <alloc_array>:
   ...
   10754:	00010980 	.word	0x00010980
...
00010800 <check_result>:
   ...
   108a4:	000109c0 	.word	0x000109c0
   108a8:	000109dc 	.word	0x000109dc
   108ac:	00000000 	.word	0x00000000

000108b0 <mat_mult_thumb>:
   108b0:	e52de004 	push	{lr}		; (str lr, [sp, #-4]!)
   108b4:	fa000001 	blx	108c0 <thumb_func>
   108b8:	e49de004 	pop	{lr}		; (ldr lr, [sp], #4)
...
000108c2 <i_loop>:
   108c2:	2400      	movs	r4, #0

000108c4 <j_loop>:
   108c4:	2500      	movs	r5, #0

000108c6 <k_loop>:
   108c6:	58c6      	ldr	r6, [r0, r3]
   108c8:	b401      	push	{r0}
   108ca:	5977      	ldr	r7, [r6, r5]
   108cc:	594e      	ldr	r6, [r1, r5]
   108ce:	b402      	push	{r1}
   108d0:	5930      	ldr	r0, [r6, r4]
   108d2:	58d6      	ldr	r6, [r2, r3]
   108d4:	5931      	ldr	r1, [r6, r4]
   108d6:	4347      	muls	r7, r0
   108d8:	19c9      	adds	r1, r1, r7
   108da:	5131      	str	r1, [r6, r4]
   108dc:	bc02      	pop	{r1}
   108de:	bc01      	pop	{r0}
   108e0:	3504      	adds	r5, #4
   108e2:	b408      	push	{r3}
   108e4:	4b09      	ldr	r3, [pc, #36]	; (1090c <addr_number>)
   108e6:	681b      	ldr	r3, [r3, #0]
   108e8:	429d      	cmp	r5, r3
   108ea:	bc08      	pop	{r3}
   108ec:	dbeb      	blt.n	108c6 <k_loop>
   108ee:	3404      	adds	r4, #4
   108f0:	b408      	push	{r3}
   108f2:	4b06      	ldr	r3, [pc, #24]	; (1090c <addr_number>)
   108f4:	681b      	ldr	r3, [r3, #0]
   108f6:	429c      	cmp	r4, r3
   108f8:	bc08      	pop	{r3}
   108fa:	dbe3      	blt.n	108c4 <j_loop>
   108fc:	3304      	adds	r3, #4
   108fe:	b410      	push	{r4}
   10900:	4c02      	ldr	r4, [pc, #8]	; (1090c <addr_number>)
   10902:	6824      	ldr	r4, [r4, #0]
   10904:	42a3      	cmp	r3, r4
   10906:	bc10      	pop	{r4}
   10908:	dbdb      	blt.n	108c2 <i_loop>
   1090a:	4770      	bx	lr

0001090c <addr_number>:
   1090c:	00021040 	.word	0x00021040

00010910 <__libc_csu_init>:
   10910:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
   10914:	e1a07000 	mov	r7, r0
   10918:	e59f6048 	ldr	r6, [pc, #72]	; 10968 <__libc_csu_init+0x58>
   1091c:	e59f5048 	ldr	r5, [pc, #72]	; 1096c <__libc_csu_init+0x5c>
   10920:	e08f6006 	add	r6, pc, r6
   10924:	e08f5005 	add	r5, pc, r5
   10928:	e0466005 	sub	r6, r6, r5
   1092c:	e1a08001 	mov	r8, r1
   10930:	e1a09002 	mov	r9, r2
   10934:	ebfffecf 	bl	10478 <_init>
   10938:	e1b06146 	asrs	r6, r6, #2
   1093c:	08bd87f0 	popeq	{r4, r5, r6, r7, r8, r9, sl, pc}
   10940:	e3a04000 	mov	r4, #0
   10944:	e2844001 	add	r4, r4, #1
   10948:	e4953004 	ldr	r3, [r5], #4
   1094c:	e1a02009 	mov	r2, r9
   10950:	e1a01008 	mov	r1, r8
   10954:	e1a00007 	mov	r0, r7
   10958:	e12fff33 	blx	r3
   1095c:	e1560004 	cmp	r6, r4
   10960:	1afffff7 	bne	10944 <__libc_csu_init+0x34>
   10964:	e8bd87f0 	pop	{r4, r5, r6, r7, r8, r9, sl, pc}
   10968:	000105e0 	.word	0x000105e0
   1096c:	000105d8 	.word	0x000105d8

00010970 <__libc_csu_fini>:
   10970:	e12fff1e 	bx	lr

Disassembly of section .fini:

00010974 <_fini>:
   10974:	e92d4008 	push	{r3, lr}
   10978:	e8bd8008 	pop	{r3, pc}
